...
# detect ir  rgb xian hou !!!!!!!!!!!!!!!
    ...
    for ((path, im_ir, im0s, vid_cap, s) ,(path, im, im0s, vid_cap, s) ) in zip(dataset2,dataset):
    # for ((path, im, im0s, vid_cap, s), (path, im_ir, im0s, vid_cap, s) ) in zip(dataset,dataset2):
        ...
        pred = model(img_rgb,img_ir, augment=augment, visualize=visualize)
        t3 = time_sync()
        dt[1] += t3 - t2
...
def parse_opt():
    ...
    parser.add_argument('--source1', type=str, default='/data/dataset/dataset_tmm/rgb', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--source2', type=str, default='/data/dataset/dataset_tmm/ir', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--visualize', default='True',action='store_true', help='visualize features')  #True
