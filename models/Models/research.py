...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if pt:  # PyTorch
            ...
            check_requirements(('openvino',))  # requires openvino-dev: 
...
class Stem1(nn.Module):
    # Stem
    def __init__(self, c1=3, c2=128, k=1, s=1, p=None, g=1, act=True):  # ch_in, ch_out, kernel, stride, padding, groups
...
class CrossAttention_rgbw(nn.Module):
    def __init__(self, input_dim_query, input_dim_keys, hidden_dim):
        super(CrossAttention_rgbw, self).__init__()
 
        self.linear_query = nn.Linear(input_dim_query, hidden_dim)
        self.linear_keys = nn.Linear(input_dim_keys, hidden_dim)


class CrossAttention_tw(nn.Module):
    def __init__(self, input_dim_query, input_dim_keys, hidden_dim):
        super(CrossAttention_tw, self).__init__()
